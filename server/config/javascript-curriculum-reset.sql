...
(3,'Level 1','Variables, Data Types, and Operators','Numeric Storage','Pip approaches a heavy stone gate requiring precise coin measurements to open.','Use whole-number variables for counting coins.','Declare numeric variables and complete the coin balance challenge.',40,4,4,0,0,'Declare numeric variables','(int|double|float|long|short|byte)',1),
(3,'Level 2','Variables, Data Types, and Operators','String Storage','An ancient signpost displays encrypted runes that Pip must translate into readable text.','Use quote-wrapped strings for text values.','Declare a text variable and show the translated message.',40,0,0,1,0,'Declare a string variable','(String|char)',2),
(3,'Level 3','Variables, Data Types, and Operators','Boolean Gate','Pip reaches a magic bridge that activates only if the protective aura is powered on.','Create a boolean value that can be turned off.','Declare a boolean and use it to control the gate.',45,3,3,0,0,'Use true or false','\\b(true|false)\\b',3),
(3,'Level 4','Variables, Data Types, and Operators','Addition Boost','Pip opens a treasure chest filled with gold coins and adds them to his pouch.','Add the current value to a new amount.','Use addition to increase the total coin count.',45,6,6,0,0,'Use the addition operator','\\+',4),
(3,'Level 5','Variables, Data Types, and Operators','Multiply Distance','Pip drinks a Speed Elixir, allowing him to leap 3 times further across the tile grid.','Multiply the movement value by a factor.','Use multiplication to calculate a stronger jump distance.',50,8,8,0,0,'Use the multiplication operator','\\*',5),
(3,'Level 6','Variables, Data Types, and Operators','Remainder Check','Pip steps onto alternating floor traps that trigger on every second tile step.','Use mod to detect even or odd steps.','Use % to test the remainder in a condition.',55,3,3,0,0,'Use the remainder operator','%',6),
(3,'Level 7','Variables, Data Types, and Operators','Assignment Upgrade','Pip engages a stone sentinel, receiving damage before consuming a health potion.','Update a value using compound arithmetic.','Use an assignment operator to change health.',55,6,6,0,0,'Use an assignment operator','(\\+=|-=|\\*=)',7),
(3,'Level 8','Variables, Data Types, and Operators','Comparison Scout','Pip approaches a locked tower door requiring a key inventory check.','Check whether a condition is true before opening.','Use a comparison in a condition to decide access.',60,4,4,0,0,'Use a comparison operator','(>=|<=|>|<|==|===)',8),
(3,'Level 9','Variables, Data Types, and Operators','Expression Mission','Pip solves an ancient arithmetic lock mechanism where order of operations matters.','Calculate the expression before moving.','Use variables and arithmetic in a single expression.',65,10,10,0,0,'Use variables in an arithmetic expression','[A-Za-z_][A-Za-z0-9_]*\\s*[+*/-]',9),
(3,'Level 10','Variables, Data Types, and Operators','Operator Arena','Pip faces the Island 3 Boss Gate, which requires evaluating combined data types, compound arithmetic, and boolean checks simultaneously.','Combine arithmetic and boolean checks in one sequence.','Use variables, math, and a comparison to pass the boss gate.',80,12,12,1,0,'Use both arithmetic and booleans','(&&|\|\||[+*/-]|==|>=)',10),
